...
class _MyHomePageState extends State<MyHomePage> {
 ...
 String url = 'https://pokeapi.co/api/v2/pokemon/pikachu';
  ...
  // Filtrando informações específicas 
    String nome = dados['name'];
    int altura = dados['height'];
    int peso = dados['weight'];
    List habilidades = dados['abilities'];
    List Ataques = dados['moves'];

    // Organizando as habilidades
    String habilidadesFormatadas = habilidades

        .map((habilidade) => habilidade['ability']['name'])
        .join(', ');
    // Organizando os ataques

    String ataquesFormatadas = Ataques
  ...
  print('Altura: $altura');
  print('Peso: $peso');
  print('Habilidades: $habilidadesFormatadas');
  print('Ataques: $ataquesFormatadas');
  } else {
    // Se o servidor retornar um código de status diferente de 200, lança uma exceção.
